  ...
  if (username == "" || password == "") {
    ...
    return true;
      ...
      function learn_music() {
        document.getElementById("welcome").setAttribute("style","display:none");
        document.getElementById("take-input").setAttribute("style","display:none");
        document.getElementById("search").setAttribute("style","display:block");
      }

      function query_lesson() {
        instrument = document.getElementById("lesson-name-input").value;
        url = "/search_lessons_for?instrument=" + instrument;
